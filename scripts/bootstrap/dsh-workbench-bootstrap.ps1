...
$HarnessForkBranch = 'rc4/presentation-on-0.1.2'
...
# not the other.
$ReleaseBaseUrl = 'https://github.com/wanyexin1998/dsh-workbench/releases/download/v0.2.0-rc.6'
...
# otherwise.
$WorkbenchTgzSha256 = 'b329024e139bd32f87cb5976e9aec5a3587a3beaaa7dd8dca53e2bfdf8c7c06b'
$ResultSchema = 1
